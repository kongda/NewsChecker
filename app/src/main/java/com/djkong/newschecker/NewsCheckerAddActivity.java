...
public class NewsCheckerAddActivity extends AppCompatActivity implements
    ...
    public void saveNewsChecker(){
        NewsCheckerDatabase rb = new NewsCheckerDatabase(this);

        // Creating NewsChecker
        int ID = rb.addNewsChecker(new NewsChecker(mTitle, mDate, mTime, mRepeat, mRepeatNo, mRepeatType, mActive, mURL, mTargetString));
