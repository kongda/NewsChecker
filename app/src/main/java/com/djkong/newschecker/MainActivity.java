...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView mNoNewsCheckerView;
    private FloatingActionButton mAddNewsCheckerButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rb = new NewsCheckerDatabase(getApplicationContext());

        // Initialize views
        mToolbar = (Toolbar) findViewById(R.id.toolbar);
        mAddNewsCheckerButton = (FloatingActionButton) findViewById(R.id.add_reminder);
        mList = (RecyclerView) findViewById(R.id.reminder_list);
        mNoNewsCheckerView = (TextView) findViewById(R.id.no_reminder_text);

        // To check is there are saved reminders
        // If there are no reminders display a message asking the user to create reminders
        List<NewsChecker> mTest = rb.getAllNewsCheckers();

        if (mTest.isEmpty()) {
            mNoNewsCheckerView.setVisibility(View.VISIBLE);
        }
        ...
        mAddNewsCheckerButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), NewsCheckerAddActivity.class);
                ...
                case R.id.discard_reminder:
                    ...
                    for (int i = IDmap.size(); i >= 0; i--) {
                        if (mMultiSelector.isSelected(i, 0)) {
                            ...
                            NewsChecker temp = rb.getNewsChecker(id);
                            // Delete reminder
                            rb.deleteNewsChecker(temp);
                    ...
                    if (mTest.isEmpty()) {
                        ...
                        mNoNewsCheckerView.setVisibility(View.GONE);
                    }
    ...
    private void selectNewsChecker(int mClickID) {
        String mStringClickID = Integer.toString(mClickID);

        // Create intent to edit the reminder
        // Put reminder id as extra
        Intent i = new Intent(this, NewsCheckerEditActivity.class);
        i.putExtra(NewsCheckerEditActivity.EXTRA_REMINDER_ID, mStringClickID);
    ...
    public class SimpleAdapter extends RecyclerView.Adapter<SimpleAdapter.VerticalItemHolder> {
        private ArrayList<NewsCheckerItem> mItems;
        ...
        public void onBindViewHolder(VerticalItemHolder itemHolder, int position) {
            NewsCheckerItem item = mItems.get(position);
            itemHolder.setNewsCheckerTitle(item.mTitle);
            itemHolder.setNewsCheckerDateTime(item.mDateTime);
            itemHolder.setNewsCheckerRepeatInfo(item.mRepeat, item.mRepeatNo, item.mRepeatType);
        ...
        public  class NewsCheckerItem {
            ...
            public NewsCheckerItem(String Title, String DateTime, String Repeat, String RepeatNo, String RepeatType, String Active) {
                this.mTitle = Title;
        ...
        public  class VerticalItemHolder extends SwappingHolder
            ...
            public void onClick(View v) {
                if (!mMultiSelector.tapSelection(this)) {
                    ...
                    int mNewsCheckerClickID = IDmap.get(mTempPost);
                    selectNewsChecker(mNewsCheckerClickID);
            ...
            public void setNewsCheckerTitle(String title) {
            ...
            public void setNewsCheckerDateTime(String datetime) {
                mDateAndTimeText.setText(datetime);
            }

            // Set repeat views
            public void setNewsCheckerRepeatInfo(String repeat, String repeatNo, String repeatType) {
        ...
        public  NewsCheckerItem generateDummyData() {
            return new NewsCheckerItem("1", "2", "3", "4", "5", "6");
        }

        // Generate real data for each item
        public List<NewsCheckerItem> generateData(int count) {
            ArrayList<SimpleAdapter.NewsCheckerItem> items = new ArrayList<>();

            // Get all reminders from the database
            List<NewsChecker> reminders = rb.getAllNewsCheckers();
            ...
            for (DateTimeSorter item:DateTimeSortList) {
                ...
                items.add(new SimpleAdapter.NewsCheckerItem(Titles.get(i), DateAndTime.get(i), Repeats.get(i),
